...
{
    public class PublicComplaintDetailsViewModel
    {
        public PublicComplaintDetailsViewModel(Complaint e)
        {
            ComplaintId = e.Id;
            Status = e.Status;
        ...
        public List<PublicComplaintActionViewModel> ComplaintActions { get; set; }
        ...
        {
            get => StringFunctions.RedactPII(_reviewComments);
        ...
        [DisplayFormat(DataFormatString = CTS.FormatDateTimeDisplay)]
        public DateTime? DateComplaintClosed { get; }
