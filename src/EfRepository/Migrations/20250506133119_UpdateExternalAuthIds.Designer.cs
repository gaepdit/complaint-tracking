...
namespace Cts.EfRepository.Migrations
{
    ...
    [Migration("20250506133119_UpdateExternalAuthIds")]
    partial class UpdateExternalAuthIds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cts.Domain.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("EntraIdSubjectId")
                        .HasMaxLength(36)
                    ...
                    b.HasIndex(new[] { "EntraIdSubjectId" }, "missing_index_198_197_A");

                    b.HasIndex(new[] { "OktaSubjectId" }, "missing_index_198_197_B");
