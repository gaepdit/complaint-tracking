...
{
    public static Expression<Func<Attachment, bool>> IdPredicate(int id) =>
        PredicateBuilder.True<Attachment>().ForComplaint(id);
    ...
    private static Expression<Func<Attachment, bool>> ForComplaint(
        this Expression<Func<Attachment, bool>> predicate, int complaintId) =>
