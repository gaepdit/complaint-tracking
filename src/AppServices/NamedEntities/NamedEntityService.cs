...
public abstract class NamedEntityService<TEntity, TViewDto, TUpdateDto>(
#pragma warning restore S2436
    ...
    : INamedEntityService<TViewDto, TUpdateDto>
...

{
    ...
    public async Task<IReadOnlyList<ListItem>> GetAsListItemsAsync(bool includeInactive = false,
        ...
        (await repository.GetOrderedListAsync(entity => includeInactive || entity.Active, token: token)
